...
Pre-built binaries for `linux/amd64`, `linux/arm64`, `darwin/amd64`, and `darwin/arm64` are published on each https://github.com/rancher-sandbox/runtime-enforcer/releases[GitHub Release].
